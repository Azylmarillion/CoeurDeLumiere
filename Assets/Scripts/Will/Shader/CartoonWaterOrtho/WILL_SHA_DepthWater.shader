Shader "Custom/WILL_SHA_DepthWater"
{
    Properties
	{
		...
		[HideInInspector][Space(20)]
		[HideInInspector]_WaterColor ("Water color", Color) = (1, 1, 1, 1)
		[HideInInspector]_WaterTex("Water texture", 2D) = "white" {}
		[HideInInspector]_Tiling ("Water tiling", Vector) = (1, 1, 1, 1)
		[HideInInspector]_TextureVisibility ("Texture visibility", Range(0, 1)) = 1

		[HideInInspector][Space(20)]
		[HideInInspector]_DistTex ("Distortion", 2D) = "white" {}
		[HideInInspector]_DistTiling ("Distortion tiling", Vector) = (1, 1, 1, 1)

		[HideInInspector][Space(20)]
		[HideInInspector]_WaterHeight ("Water height", Float) = 0
		[HideInInspector]_WaterDeep ("Water deep", Float) = 0
		[HideInInspector]_WaterDepth ("Water depth param", Range(0, 0.1)) = 0
		[HideInInspector]_WaterMinAlpha ("Water min alpha", Range(0, 1)) = 0
		
		[HideInInspector][Space(20)]
		[HideInInspector]_BorderColor ("Border color", Color) = (1, 1, 1, 1)
		[HideInInspector]_BorderWidth ("Border width", Range(0, 1)) = 0

		[HideInInspector][Space(20)]
		[HideInInspector]_MoveDirection ("Direction", Vector) = (0, 0, 0, 0)
	}
	SubShader
	{
